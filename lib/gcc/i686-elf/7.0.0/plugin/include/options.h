...
enum opt_code
{
  ...
  OPT_Wduplicate_decl_specifier = 222,       /* -Wduplicate-decl-specifier */
  ...
  OPT_Wmemset_elt_size = 297,                /* -Wmemset-elt-size */
  ...
  OPT_ffilelist_file = 683,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 684,               /* -ffinite-math-only */
  OPT_ffixed_ = 685,                         /* -ffixed- */
  OPT_ffixed_form = 686,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 687,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 688,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 689,                    /* -ffloat-store */
  OPT_ffor_scope = 690,                      /* -ffor-scope */
  /* OPT_fforce_addr = 691, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 692,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 693,              /* -fforward-propagate */
  OPT_ffp_contract_ = 694,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 695,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 696,                      /* -ffpe-trap= */
  OPT_ffree_form = 697,                      /* -ffree-form */
  OPT_ffree_line_length_ = 698,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 699,          /* -ffree-line-length-none */
  OPT_ffreestanding = 700,                   /* -ffreestanding */
  OPT_ffriend_injection = 701,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 702,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 703,                   /* -ffunction-cse */
  OPT_ffunction_sections = 704,              /* -ffunction-sections */
  OPT_fgcse = 705,                           /* -fgcse */
  OPT_fgcse_after_reload = 706,              /* -fgcse-after-reload */
  OPT_fgcse_las = 707,                       /* -fgcse-las */
  OPT_fgcse_lm = 708,                        /* -fgcse-lm */
  OPT_fgcse_sm = 709,                        /* -fgcse-sm */
  OPT_fgnat_encodings_ = 710,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 711,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 712,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 713,                         /* -fgnu-tm */
  OPT_fgnu_unique = 714,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 715,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 716,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 717,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 718,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 719,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 720,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 721,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 722,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 723,                       /* -fgraphite */
  OPT_fgraphite_identity = 724,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 725,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 726, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 727, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 728,           /* -fhash-synchronization */
  /* OPT_fhelp = 729, */                     /* -fhelp */
  /* OPT_fhelp_ = 730, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 731,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 732, */                /* -fhonor-std */
  OPT_fhosted = 733,                         /* -fhosted */
  /* OPT_fhuge_objects = 734, */             /* -fhuge-objects */
  OPT_fident = 735,                          /* -fident */
  OPT_fif_conversion = 736,                  /* -fif-conversion */
  OPT_fif_conversion2 = 737,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 738,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 739,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 740,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 741,             /* -fimplicit-templates */
  OPT_findirect_classes = 742,               /* -findirect-classes */
  OPT_findirect_dispatch = 743,              /* -findirect-dispatch */
  OPT_findirect_inlining = 744,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 745,         /* -finhibit-size-directive */
  OPT_finit_character_ = 746,                /* -finit-character= */
  OPT_finit_integer_ = 747,                  /* -finit-integer= */
  OPT_finit_local_zero = 748,                /* -finit-local-zero */
  OPT_finit_logical_ = 749,                  /* -finit-logical= */
  OPT_finit_real_ = 750,                     /* -finit-real= */
  OPT_finline = 751,                         /* -finline */
  OPT_finline_atomics = 752,                 /* -finline-atomics */
  OPT_finline_functions = 753,               /* -finline-functions */
  OPT_finline_functions_called_once = 754,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 755, */            /* -finline-limit- */
  OPT_finline_limit_ = 756,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 757,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 758,         /* -finline-small-functions */
  OPT_finput_charset_ = 759,                 /* -finput-charset= */
  OPT_finstrument_functions = 760,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 761,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 762,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 763,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 764,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 765,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 766,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 767,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 768,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 769,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 770,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 771,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 772, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 773,                    /* -fipa-profile */
  OPT_fipa_pta = 774,                        /* -fipa-pta */
  OPT_fipa_pure_const = 775,                 /* -fipa-pure-const */
  OPT_fipa_ra = 776,                         /* -fipa-ra */
  OPT_fipa_reference = 777,                  /* -fipa-reference */
  OPT_fipa_sra = 778,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 779, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 780,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 781,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 782,              /* -fira-loop-pressure */
  OPT_fira_region_ = 783,                    /* -fira-region= */
  OPT_fira_share_save_slots = 784,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 785,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 786,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 787,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 788,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 789,               /* -fivar-visibility= */
  OPT_fivopts = 790,                         /* -fivopts */
  OPT_fjni = 791,                            /* -fjni */
  OPT_fjump_tables = 792,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 793,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 794,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 795,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 796,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 797,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 798, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 799,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 800,             /* -fleading-underscore */
  OPT_flifetime_dse = 801,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 802,                  /* -flifetime-dse= */
  OPT_flinker_output_ = 803,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 804,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 805,                    /* -flocal-ivars */
  /* OPT_floop_block = 806, */               /* -floop-block */
  /* OPT_floop_flatten = 807, */             /* -floop-flatten */
  /* OPT_floop_interchange = 808, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 809,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 810, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 811,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 812, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 813, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 814,                      /* -flra-remat */
  OPT_flto = 815,                            /* -flto */
  OPT_flto_compression_level_ = 816,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 817,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 818,                 /* -flto-partition= */
  OPT_flto_report = 819,                     /* -flto-report */
  OPT_flto_report_wpa = 820,                 /* -flto-report-wpa */
  OPT_flto_ = 821,                           /* -flto= */
  OPT_fltrans = 822,                         /* -fltrans */
  OPT_fltrans_output_list_ = 823,            /* -fltrans-output-list= */
  OPT_fmain_ = 824,                          /* -fmain= */
  OPT_fmath_errno = 825,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 826,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 827,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 828,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 829,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 830,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 831,                     /* -fmem-report */
  OPT_fmem_report_wpa = 832,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 833,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 834,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 835,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 836,                /* -fmessage-length= */
  OPT_fmodule_private = 837,                 /* -fmodule-private */
  OPT_fmodulo_sched = 838,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 839,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 840,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 841,                  /* -fms-extensions */
  /* OPT_fmudflap = 842, */                  /* -fmudflap */
  /* OPT_fmudflapir = 843, */                /* -fmudflapir */
  /* OPT_fmudflapth = 844, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 845, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 846, */                  /* -fnew-abi */
  OPT_fnext_runtime = 847,                   /* -fnext-runtime */
  OPT_fnil_receivers = 848,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 849, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 850,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 851,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 852, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 853,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 854,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 855,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 856,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 857,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 858,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 859,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 860,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 861,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 862,                   /* -foffload-abi= */
  OPT_foffload_ = 863,                       /* -foffload= */
  OPT_fomit_frame_pointer = 864,             /* -fomit-frame-pointer */
  OPT_fopenacc = 865,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 866,                   /* -fopenacc-dim= */
  OPT_fopenmp = 867,                         /* -fopenmp */
  OPT_fopenmp_simd = 868,                    /* -fopenmp-simd */
  OPT_foperator_names = 869,                 /* -foperator-names */
  OPT_fopt_info = 870,                       /* -fopt-info */
  OPT_fopt_info_ = 871,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 872, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 873,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 874,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 875,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 876, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 877,              /* -foutput-class-dir= */
  OPT_fpack_derived = 878,                   /* -fpack-derived */
  OPT_fpack_struct = 879,                    /* -fpack-struct */
  OPT_fpack_struct_ = 880,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 881,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 882,              /* -fpcc-struct-return */
  OPT_fpch_deps = 883,                       /* -fpch-deps */
  OPT_fpch_preprocess = 884,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 885,                     /* -fpeel-loops */
  OPT_fpeephole = 886,                       /* -fpeephole */
  OPT_fpeephole2 = 887,                      /* -fpeephole2 */
  OPT_fpermissive = 888,                     /* -fpermissive */
  OPT_fpic = 889,                            /* -fpic */
  OPT_fpie = 890,                            /* -fpie */
  OPT_fplan9_extensions = 891,               /* -fplan9-extensions */
  OPT_fplt = 892,                            /* -fplt */
  OPT_fplugin_arg_ = 893,                    /* -fplugin-arg- */
  OPT_fplugin_ = 894,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 895,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 896,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 897,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 898,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 899,                   /* -fpreprocessed */
  OPT_fpretty_templates = 900,               /* -fpretty-templates */
  OPT_fprofile = 901,                        /* -fprofile */
  OPT_fprofile_arcs = 902,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 903,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 904,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 905,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 906,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 907,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 908,                 /* -fprofile-report */
  OPT_fprofile_use = 909,                    /* -fprofile-use */
  OPT_fprofile_use_ = 910,                   /* -fprofile-use= */
  OPT_fprofile_values = 911,                 /* -fprofile-values */
  OPT_fprotect_parens = 912,                 /* -fprotect-parens */
  OPT_frandom_seed = 913,                    /* -frandom-seed */
  OPT_frandom_seed_ = 914,                   /* -frandom-seed= */
  OPT_frange_check = 915,                    /* -frange-check */
  OPT_freal_4_real_10 = 916,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 917,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 918,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 919,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 920,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 921,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 922,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 923,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 924,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 925,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 926,                /* -frecord-marker=8 */
  OPT_frecursive = 927,                      /* -frecursive */
  OPT_freduced_reflection = 928,             /* -freduced-reflection */
  OPT_free = 929,                            /* -free */
  OPT_freg_struct_return = 930,              /* -freg-struct-return */
  /* OPT_fregmove = 931, */                  /* -fregmove */
  OPT_frename_registers = 932,               /* -frename-registers */
  OPT_freorder_blocks = 933,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 934,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 935,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 936,              /* -freorder-functions */
  OPT_frepack_arrays = 937,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 938,           /* -freplace-objc-classes */
  OPT_frepo = 939,                           /* -frepo */
  OPT_freport_bug = 940,                     /* -freport-bug */
  OPT_frequire_return_statement = 941,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 942,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 943, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 944,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 945,                    /* -fresolution= */
  OPT_frounding_math = 946,                  /* -frounding-math */
  OPT_frtti = 947,                           /* -frtti */
  OPT_fsanitize_coverage_trace_pc = 948,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 949,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 950,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 951,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 952,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 953,                      /* -fsanitize= */
  OPT_fsaw_java_file = 954,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 955,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 956,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 957,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 958,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 959,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 960,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 961,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 962,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 963,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 964,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 965,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 966,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 967,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 968,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 969,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 970,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 971,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 972, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 973,                /* -fschedule-fusion */
  OPT_fschedule_insns = 974,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 975,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 976,              /* -fsecond-underscore */
  OPT_fsection_anchors = 977,                /* -fsection-anchors */
  /* OPT_fsee = 978, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 979,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 980,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 981, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 982,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 983,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 984,         /* -fsemantic-interposition */
  OPT_fshort_enums = 985,                    /* -fshort-enums */
  OPT_fshort_wchar = 986,                    /* -fshort-wchar */
  OPT_fshow_column = 987,                    /* -fshow-column */
  OPT_fshrink_wrap = 988,                    /* -fshrink-wrap */
  OPT_fsign_zero = 989,                      /* -fsign-zero */
  OPT_fsignaling_nans = 990,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 991,               /* -fsigned-bitfields */
  OPT_fsigned_char = 992,                    /* -fsigned-char */
  OPT_fsigned_zeros = 993,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 994,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 995,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 996,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 997,               /* -fsource-filename= */
  OPT_fsource_ = 998,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 999,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_paths = 1000,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1001,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1002,              /* -fsplit-wide-types */
  /* OPT_fsquangle = 1003, */                /* -fsquangle */
  OPT_fssa_backprop = 1004,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1005,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1006,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1007,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1008, */             /* -fstack-check */
  OPT_fstack_check_ = 1009,                  /* -fstack-check= */
  OPT_fstack_limit = 1010,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1011,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1012,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1013,               /* -fstack-protector */
  OPT_fstack_protector_all = 1014,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1015,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1016,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1017,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1018,                   /* -fstack-usage */
  OPT_fstats = 1019,                         /* -fstats */
  OPT_fstdarg_opt = 1020,                    /* -fstdarg-opt */
  OPT_fstore_check = 1021,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1022, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1023,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1024,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1025,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1026, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1027,     /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 1028,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1029,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1030,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1031, */             /* -ftarget-help */
  OPT_ftarget_ = 1032,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1033,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1034, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1035,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1036,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1037, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1038,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1039,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1040,                   /* -ftime-report */
  ...
  OPT_fuse_atomic_builtins = 1104,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1105,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1106,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1107,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1108,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1109,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1110,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1111,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1112,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1113,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1114,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1115,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1116,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1117, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1118,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1119,                   /* -fverbose-asm */
  /* OPT_fversion = 1120, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1121,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1122,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1123,                   /* -fvisibility= */
  OPT_fvpt = 1124,                           /* -fvpt */
  /* OPT_fvtable_gc = 1125, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1126, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1127,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1128,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1129,                     /* -fvtv-debug */
  OPT_fweak = 1130,                          /* -fweak */
  OPT_fweb = 1131,                           /* -fweb */
  /* OPT_fwhole_file = 1132, */              /* -fwhole-file */
  OPT_fwhole_program = 1133,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1134,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1135,             /* -fworking-directory */
  OPT_fwpa = 1136,                           /* -fwpa */
  OPT_fwpa_ = 1137,                          /* -fwpa= */
  OPT_fwrapv = 1138,                         /* -fwrapv */
  /* OPT_fxref = 1139, */                    /* -fxref */
  /* OPT_fzee = 1140, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1141,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1142,                     /* -fzero-link */
  OPT_g = 1143,                              /* -g */
  OPT_gant = 1144,                           /* -gant */
  OPT_gcoff = 1145,                          /* -gcoff */
  OPT_gdwarf = 1146,                         /* -gdwarf */
  OPT_gdwarf_ = 1147,                        /* -gdwarf- */
  OPT_gen_decls = 1148,                      /* -gen-decls */
  OPT_ggdb = 1149,                           /* -ggdb */
  OPT_ggnu_pubnames = 1150,                  /* -ggnu-pubnames */
  OPT_gnat = 1151,                           /* -gnat */
  OPT_gnatO = 1152,                          /* -gnatO */
  OPT_gno_pubnames = 1153,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1154,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1155,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1156,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1157,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1158,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1159,                   /* -gsplit-dwarf */
  OPT_gstabs = 1160,                         /* -gstabs */
  OPT_gstabs_ = 1161,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1162,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1163,                        /* -gtoggle */
  OPT_gvms = 1164,                           /* -gvms */
  OPT_gxcoff = 1165,                         /* -gxcoff */
  OPT_gxcoff_ = 1166,                        /* -gxcoff+ */
  OPT_gz = 1167,                             /* -gz */
  OPT_gz_ = 1168,                            /* -gz= */
  OPT_h = 1169,                              /* -h */
  OPT_idirafter = 1170,                      /* -idirafter */
  OPT_imacros = 1171,                        /* -imacros */
  OPT_imultiarch = 1172,                     /* -imultiarch */
  OPT_imultilib = 1173,                      /* -imultilib */
  OPT_include = 1174,                        /* -include */
  OPT_iplugindir_ = 1175,                    /* -iplugindir= */
  OPT_iprefix = 1176,                        /* -iprefix */
  OPT_iquote = 1177,                         /* -iquote */
  OPT_isysroot = 1178,                       /* -isysroot */
  OPT_isystem = 1179,                        /* -isystem */
  OPT_iwithprefix = 1180,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1181,              /* -iwithprefixbefore */
  OPT_k8 = 1182,                             /* -k8 */
  OPT_l = 1183,                              /* -l */
  OPT_lang_asm = 1184,                       /* -lang-asm */
  OPT_m128bit_long_double = 1185,            /* -m128bit-long-double */
  OPT_m16 = 1186,                            /* -m16 */
  OPT_m32 = 1187,                            /* -m32 */
  OPT_m3dnow = 1188,                         /* -m3dnow */
  OPT_m3dnowa = 1189,                        /* -m3dnowa */
  OPT_m64 = 1190,                            /* -m64 */
  OPT_m80387 = 1191,                         /* -m80387 */
  OPT_m8bit_idiv = 1192,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1193,             /* -m96bit-long-double */
  OPT_mabi_ = 1194,                          /* -mabi= */
  OPT_mabm = 1195,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1196,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1197,                 /* -maddress-mode= */
  OPT_madx = 1198,                           /* -madx */
  OPT_maes = 1199,                           /* -maes */
  OPT_malign_data_ = 1200,                   /* -malign-data= */
  OPT_malign_double = 1201,                  /* -malign-double */
  OPT_malign_functions_ = 1202,              /* -malign-functions= */
  OPT_malign_jumps_ = 1203,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1204,                  /* -malign-loops= */
  OPT_malign_stringops = 1205,               /* -malign-stringops */
  OPT_march_ = 1206,                         /* -march= */
  OPT_masm_ = 1207,                          /* -masm= */
  OPT_mavx = 1208,                           /* -mavx */
  OPT_mavx2 = 1209,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1210,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1211,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1212,                      /* -mavx512bw */
  OPT_mavx512cd = 1213,                      /* -mavx512cd */
  OPT_mavx512dq = 1214,                      /* -mavx512dq */
  OPT_mavx512er = 1215,                      /* -mavx512er */
  OPT_mavx512f = 1216,                       /* -mavx512f */
  OPT_mavx512ifma = 1217,                    /* -mavx512ifma */
  OPT_mavx512pf = 1218,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1219,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1220,                      /* -mavx512vl */
  OPT_mbmi = 1221,                           /* -mbmi */
  OPT_mbmi2 = 1222,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1223,                  /* -mbranch-cost= */
  OPT_mcld = 1224,                           /* -mcld */
  OPT_mclflushopt = 1225,                    /* -mclflushopt */
  OPT_mclwb = 1226,                          /* -mclwb */
  OPT_mclzero = 1227,                        /* -mclzero */
  OPT_mcmodel_ = 1228,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1229, */                    /* -mcpu= */
  OPT_mcrc32 = 1230,                         /* -mcrc32 */
  OPT_mcx16 = 1231,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1232,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1233,            /* -mdump-tune-features */
  OPT_mf16c = 1234,                          /* -mf16c */
  OPT_mfancy_math_387 = 1235,                /* -mfancy-math-387 */
  OPT_mfentry = 1236,                        /* -mfentry */
  OPT_mfma = 1237,                           /* -mfma */
  OPT_mfma4 = 1238,                          /* -mfma4 */
  OPT_mforce_drap = 1239,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1240,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1241,                       /* -mfpmath= */
  OPT_mfsgsbase = 1242,                      /* -mfsgsbase */
  ...
  OPT_mveclibabi_ = 1321,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1322,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1323,                    /* -mvzeroupper */
  OPT_mx32 = 1324,                           /* -mx32 */
  OPT_mxop = 1325,                           /* -mxop */
  OPT_mxsave = 1326,                         /* -mxsave */
  OPT_mxsavec = 1327,                        /* -mxsavec */
  OPT_mxsaveopt = 1328,                      /* -mxsaveopt */
  OPT_mxsaves = 1329,                        /* -mxsaves */
  OPT_n = 1330,                              /* -n */
  ...
  OPT_nostartfiles = 1336,                   /* -nostartfiles */
  OPT_nostdinc = 1337,                       /* -nostdinc */
  OPT_nostdinc__ = 1338,                     /* -nostdinc++ */
  OPT_nostdlib = 1339,                       /* -nostdlib */
  OPT_o = 1340,                              /* -o */
  OPT_p = 1341,                              /* -p */
  OPT_pass_exit_codes = 1342,                /* -pass-exit-codes */
  /* OPT_pedantic = 1343, */                 /* -pedantic */
  OPT_pedantic_errors = 1344,                /* -pedantic-errors */
  OPT_pg = 1345,                             /* -pg */
  OPT_pie = 1346,                            /* -pie */
  OPT_pipe = 1347,                           /* -pipe */
  ...
  OPT_quiet = 1359,                          /* -quiet */
  OPT_r = 1360,                              /* -r */
  OPT_remap = 1361,                          /* -remap */
  OPT_s = 1362,                              /* -s */
  OPT_s_bc_abi = 1363,                       /* -s-bc-abi */
  OPT_save_temps = 1364,                     /* -save-temps */
  OPT_save_temps_ = 1365,                    /* -save-temps= */
  OPT_shared = 1366,                         /* -shared */
  OPT_shared_libgcc = 1367,                  /* -shared-libgcc */
  /* OPT_specs = 1368, */                    /* -specs */
  OPT_specs_ = 1369,                         /* -specs= */
  OPT_static = 1370,                         /* -static */
  OPT_static_libasan = 1371,                 /* -static-libasan */
  OPT_static_libgcc = 1372,                  /* -static-libgcc */
  OPT_static_libgcj = 1373,                  /* -static-libgcj */
  OPT_static_libgfortran = 1374,             /* -static-libgfortran */
  OPT_static_libgo = 1375,                   /* -static-libgo */
  OPT_static_liblsan = 1376,                 /* -static-liblsan */
  OPT_static_libmpx = 1377,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1378,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1379,               /* -static-libstdc++ */
  OPT_static_libtsan = 1380,                 /* -static-libtsan */
  OPT_static_libubsan = 1381,                /* -static-libubsan */
  /* OPT_std_c__03 = 1382, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1383, */                /* -std=c++0x */
  OPT_std_c__11 = 1384,                      /* -std=c++11 */
  OPT_std_c__14 = 1385,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1386, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1387, */                /* -std=c++1y */
  OPT_std_c__1z = 1388,                      /* -std=c++1z */
  OPT_std_c__98 = 1389,                      /* -std=c++98 */
  OPT_std_c11 = 1390,                        /* -std=c11 */
  ...
  OPT_std_gnu__98 = 1408,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1409,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1410, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1411, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1412,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1413,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1414, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1415, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1416,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1417, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1418, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1419, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1420,                     /* -std=legacy */
  OPT_symbolic = 1421,                       /* -symbolic */
  OPT_t = 1422,                              /* -t */
  OPT_time = 1423,                           /* -time */
  OPT_time_ = 1424,                          /* -time= */
